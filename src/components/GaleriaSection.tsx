...
const photos = [
  ...
  { src: "/images/rapidaforma/obra-08.jpeg", alt: "Instalacao de revestimento ceramico" },
  { src: "/images/rapidaforma/obra-09.jpeg", alt: "Reforma com acabamento em piso" },
  { src: "/images/rapidaforma/obra-11.jpeg", alt: "Execucao de obra estrutural" },
    ...
    <div className="container">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Obras e Resultados <span className="text-gradient">RapidaForma</span>
        </h2>
        <p className="text-muted-foreground text-lg">
          Registro real de servicos de pintura, reforma, pisos e revestimentos executados pela equipe.
        </p>
      </motion.div>
